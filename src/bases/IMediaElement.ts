...
export class MediaElement implements IMediaElement{
    ...
    constructCanvas(canvasElement:HTMLDivElement){
        ...
        for (let index = 0; index < 2; index++) {
            ...
            if (index===0) {imageElement.classList.add('active'); videoElement.classList.add('active');;bannerElement.classList.add('active');}
            if (index===1) {imageElement.classList.add('inactive'); videoElement.classList.add('inactive');bannerElement.classList.add('inactive');}
